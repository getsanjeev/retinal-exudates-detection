...
def exudates_detection(image):
	ret,exudate_candidate = cv2.threshold(image,(np.mean(image) + np.amax(image))/2 + 20,255,cv2.THRESH_BINARY)
...
def extract_bv(image):			
	...
	bv_edges = cv2.Canny(blood_vessels,150,200)
	return bv_edges
	
if __name__ == "__main__":
	pathFolder = "/home/sherlock/Internship@iit/exudate-detection/DRIVE/"
	filesArray = [x for x in os.listdir(pathFolder) if os.path.isfile(os.path.join(pathFolder,x))]
	bvDestinationFolder = "/home/sherlock/Internship@iit/exudate-detection/DRIVE-bloodvessel/"
	exDestinationFolder = "/home/sherlock/Internship@iit/exudate-detection/DRIVE-exudate/"
	colDestinationFolder = "/home/sherlock/Internship@iit/exudate-detection/DRIVE-color/"
	odDestinationFolder = "/home/sherlock/Internship@iit/exudate-detection/DRIVE-od/"
	...
	for file_name in filesArray:
		...
		cv2.imwrite(colDestinationFolder+file_name_no_extension+"_color.jpg",image_bin1)		
		...
		cv2.imwrite(exDestinationFolder+file_name_no_extension+"_exudates.jpg",qimage)